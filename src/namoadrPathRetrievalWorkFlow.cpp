...
void printQueryTimes(const std::vector<double>& hborQueryTimes, const std::vector<double>& boaQueryTimes) {
    std::cout << "MBOR Query Times (in ms):" << std::endl;
...
void processQueries(const std::string& mapName, int nPar) {
    ...
    while (std::getline(queryFile, line) && (queryCount <= 0 || queryID < queryCount)) {
        ...
        std::cout << "Query (" << startNode << ", " << endNode << ") -  NAMOADR: " << namorNsolutions << " solutions." << std::endl;
        std::cout << "Time used -  NAMOADR: " << namorQueryTime*1000 << " milliseconds." << std::endl;
...
//         queryID++;
    ...
    std::cout << "Average NAMOADR number of solutions: " << namorAverageSolutions << "\n"; // Output average solutions
    std::cout << "Average NAMOADR query time: " << namorAverageTime*1000 << " milliseconds.\n";
    std::cout << "Average NAMOADR memory usage: " << namorAverageMemoryUsage << "KB.\n";
